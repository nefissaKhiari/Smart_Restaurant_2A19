...
QSqlQueryModel* Equipement::afficher()
{
    QSqlQueryModel* model=new QSqlQueryModel();
          ...
          model->setHeaderData(3, Qt::Horizontal, QObject::tr("id_employee"));
    return model;
}
...
bool Equipement::modifier(int id_equipement)
{
    ...
    query.bindValue(":id_equipement",0);
    query.bindValue(":materiel",1);
    query.bindValue(":poste",2);
    query.bindValue(":id_employee",3);
    return query.exec();
}
