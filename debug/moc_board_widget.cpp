/****************************************************************************
** Meta object code from reading C++ file 'board_widget.h'
**
...
#error "The header file 'board_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 11), // "piece_moved"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 12), // "change_image"
QT_MOC_LITERAL(4, 38, 3), // "img"
QT_MOC_LITERAL(5, 42, 10), // "lock_board"
QT_MOC_LITERAL(6, 53, 4) // "lock"

    },
    "BoardWidget\0piece_moved\0\0change_image\0"
    "img\0lock_board\0lock"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->piece_moved(); break;
        case 1: _t->change_image((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->lock_board((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardWidget::piece_moved)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BoardWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BoardWidget.data,
      qt_meta_data_BoardWidget,  qt_static_metacall, nullptr, nullptr}
};
